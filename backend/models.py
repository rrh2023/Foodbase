...
class Recipe(db.Model):
    ...
    thumbnailUrl = db.Column(db.String(2000), unique=True, nullable=False)
    ...
    source = db.Column(db.String(200), unique=False,nullable=False)
    url = db.Column(db.String(2000), unique=False,nullable=False)
    shareAs = db.Column(db.String(200), unique=False,nullable=False)
    recipeYield =  db.Column(db.Integer, unique=False,nullable=False)
    mealType = db.Column(db.String(200), unique=False,nullable=False)
    dishType = db.Column(db.String(200), unique=False,nullable=False)
